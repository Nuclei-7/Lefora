...
const LandingPage = ({ currentPage, handleNavClick }) => {
  return (
    <div>
      ...
      <section className="about-section">
        <h2>About Lefora</h2>
        <p>
          Lefora is a forum for home gardeners to share tips, tricks, and advice
          about gardening. Whether you're a beginner or an expert, our community
